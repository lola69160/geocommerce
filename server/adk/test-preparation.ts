...
async function testPreparationAgent() {
  console.log('🧪 Testing PreparationAgent instantiation...\n');

  try {
    // Test 1: Instantiate agent
    console.log('Test 1: Agent instantiation');
    const agent = new PreparationAgent();
    console.log('✅ PreparationAgent instantiated successfully');
    ...
    console.log('\n📝 Note: Full execution test requires Runner setup');
